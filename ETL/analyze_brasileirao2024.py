...
# Caminho para o arquivo Excel com várias abas
arquivo_excel = "File/Tables.xlsx"

# Lê todas as abas (retorna um dicionário)
todas_abas = pd.read_excel(arquivo_excel, sheet_name=None)

# Lista os nomes das abas disponíveis
print("Abas disponíveis:", todas_abas.keys())

# Acessar uma aba específica por nome
# df_rodadas = pd.read_excel(arquivo_excel, sheet_name="Rodadas-2024")
# df_classificacao = pd.read_excel(arquivo_excel, sheet_name="Classificação")

# # Ou, se estiver usando o dicionário:
# # df_rodadas = todas_abas["Rodadas-2024"]
# # df_classificacao = todas_abas["Classificação"]
